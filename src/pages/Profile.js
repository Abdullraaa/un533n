...
const Profile = () => {
  ...
  return (
    <div className="px-8 py-16">
      ...
      <div className="max-w-4xl mx-auto bg-white text-primary shadow-md rounded-lg p-4 sm:p-8">
          ...
          {!editMode ? (
            ...
            <form onSubmit={handleProfileUpdate} className="space-y-4">
              <div>
                ...
                <input type="text" id="firstName" value={profileForm.first_name} onChange={(e) => setProfileForm({ ...profileForm, first_name: e.target.value })} className="w-full p-2 border border-gray-300 rounded bg-white text-primary" />
              </div>
              <div>
                <label htmlFor="lastName" className="block">Last Name</label>
                <input type="text" id="lastName" value={profileForm.last_name} onChange={(e) => setProfileForm({ ...profileForm, last_name: e.target.value })} className="w-full p-2 border border-gray-300 rounded bg-white text-primary" />
              </div>
